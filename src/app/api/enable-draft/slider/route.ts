...
export async function GET(request: Request) {
  ...
  const slider = await getSliderById(id, true);
  console.log('enable-draft-slider', slider?.sys.id, id);
  ...
  return NextResponse.redirect(new URL(`/slider-preview?id=${id}`, request.url));
}
