...
export async function GET(request: Request) {
  ...
  const footer = await getFooterById(id, true);
  console.log('enable-draft-footer', footer?.sys.id, id);
  ...
  return NextResponse.redirect(new URL(`/footer-preview?id=${id}`, request.url));
}
