            ...
            <div className="space-y-4">
              ...
              <div className="border-l-4 border-green-500 pl-4">
                ...
                <p className="text-sm text-gray-600 mb-2">
                  The title for this slider. Used for internal organization and may be displayed
              ...
              <div className="border-l-4 border-purple-500 pl-4">
                ...
                <p className="text-sm text-gray-600 mb-2">
                  Collection of items to display in the slider. Can include SliderItems, Posts,
                  Images, TimelineItems, TeamMembers, or Solutions.
                </p>
                <div className="text-xs text-gray-500">
                  Current value:{' '}
                  {props.itemsCollection?.items
                ...
                {props.itemsCollection?.items && props.itemsCollection.items.length > 0 && (
                  <div className="mt-2 text-xs text-gray-400">
                    Item types:{' '}
                    {props.itemsCollection.items
                      .map((item) => item.__typename ?? 'Unknown')
                      .join(', ')}
                  </div>
                )}
              </div>
